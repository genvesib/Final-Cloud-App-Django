...
class Question(models.Model):
    ...
    question_text = models.CharField(
        max_length=200)  # The question text content
    ...
    def is_get_score(self, selected_choices):
        ...
        correct_choices_set = set(correct_choices.values_list('id', flat=True))
        return selected_choices_set == correct_choices_set
...
class Choice(models.Model):
    ...
    choice_text = models.CharField(max_length=100)  # The choice text content
...
class Submission(models.Model):
    enrollment = models.ForeignKey('Enrollment', on_delete=models.CASCADE)  # One-to-Many relationship with Enrollment
